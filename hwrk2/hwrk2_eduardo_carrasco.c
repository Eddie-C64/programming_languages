...
int case_one() {
	int alpha[ALPHA];
	int beta[ALPHA];		// Q1.2: Fix the error
	...
	printf("Solution: BETA needs to be defined as a constant  not a intial variable.");
...
void case_five() {
	...
	printf("\nSolution: Different programs use different compliers. In visual basic we may have several layers analyzing the code before it compiles the code. As compared to gcc it just a simple layer that complies the program.");
}
